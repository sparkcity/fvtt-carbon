 ...
 * Repository: https://gitlab.com/foundrynet/carbon2185
 * Issue Tracker: https://gitlab.com/foundrynet/carbon2185/issues
 */
...
Hooks.once("init", function() {
  ...
  Actors.registerSheet("carbon2185", ActorSheet5eCharacter, {
    types: ["character"],
    makeDefault: true,
    label: "DND5E.SheetClassCharacter"
  });
  Actors.registerSheet("carbon2185", ActorSheet5eNPC, {
    types: ["npc"],
    makeDefault: true,
    label: "DND5E.SheetClassNPC"
  });
  Actors.registerSheet('carbon2185', ActorSheet5eVehicle, {
    types: ['vehicle'],
    makeDefault: true,
    label: "DND5E.SheetClassVehicle"
  });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("carbon2185", ItemSheet5e, {
    makeDefault: true,
...
Hooks.once("ready", function() {
  ...
  const currentVersion = game.settings.get("carbon2185", "systemMigrationVersion");
...
Hooks.on("canvasInit", function() {
  ...
  canvas.grid.diagonalRule = game.settings.get("carbon2185", "diagonalMovement");
...
Hooks.on("renderChatMessage", (app, html, data) => {
  ...
  if (game.settings.get("carbon2185", "autoCollapseItemCards")) html.find(".card-content").hide();
});
