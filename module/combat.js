...
export const _getInitiativeFormula = function(combatant) {
  ...
  if (actor.getFlag("carbon2185", "halflingLucky")) mods += "r=1";
  if (actor.getFlag("carbon2185", "initiativeAdv")) {
    nd = 2;
    mods += "kh";
  }
  ...
  const tiebreaker = game.settings.get("carbon2185", "initiativeDexTiebreaker");
