...
export const migrateWorld = async function() {
  ...
  game.settings.set("carbon2185", "systemMigrationVersion", game.system.data.version);
  //ui.notifications.info(`Carbon2185 System Migration to version ${game.system.data.version} completed!`, {permanent: true});
};
...
function cleanActorData(actorData) {
  ...
  if ( actorData.flags.carbon2185 ) {
    actorData.flags.carbon2185 = filterObject(actorData.flags.carbon2185, allowedFlags);
  }
...
export async function purgeFlags(pack) {
  const cleanFlags = (flags) => {
    const flags5e = flags.carbon2185 || null;
    return flags5e ? {carbon2185: flags5e} : {};
  };
