...
export default class ActorSheet5e extends ActorSheet {
  ...
  /** @override */
  get template() {
    if ( !game.user.isGM && this.actor.limited ) return "systems/carbon2185/templates/actors/limited-sheet.html";
    return `systems/carbon2185/templates/actors/${this.actor.data.type}-sheet.html`;
  }
  ...
  async _onDropActor(event, data) {
    const canPolymorph = game.user.isGM || (this.actor.owner && game.settings.get('carbon2185', 'allowPolymorphing'));
    ...
    const rememberOptions = html => {
      ...
      const settings = mergeObject(game.settings.get('carbon2185', 'polymorphSettings') || {}, options);
      game.settings.set('carbon2185', 'polymorphSettings', settings);
      return settings;
    };
    ...
    return new Dialog({
      ...
      classes: ['dialog', 'carbon2185'],
      width: 600,
      template: 'systems/carbon2185/templates/apps/polymorph-prompt.html'
    }).render(true);
  }
